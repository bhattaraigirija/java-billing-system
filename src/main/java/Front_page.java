    ...
    Front_page(){
     ...
     JLabel background= new JLabel(img);
      ...
      //Language section
       ...
       background.add(jl); 
       String language[] ={"<html><head><title></title></head><body><font style='color:green; '>English</font></body></html>","<html><head><title></title></head><body><font style='color:green;  background-color:pink;'>Nepali</font></body></html>"};
